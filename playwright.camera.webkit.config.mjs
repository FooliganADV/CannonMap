...
export default defineConfig({
  testDir:'./tests',
  testMatch:['browser/camera-readiness-webkit.spec.mjs','browser/trail-live-recovery.spec.mjs'],
  timeout:30000,
  fullyParallel:false,
  workers:process.platform==='win32'?1:undefined,
  reporter:'list',
  use:{baseURL:`http://127.0.0.1:${testPort}`,browserName:'webkit',serviceWorkers:'block',trace:'retain-on-failure',screenshot:'only-on-failure'},

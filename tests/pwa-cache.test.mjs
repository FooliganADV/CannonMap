...
test('Mission Control cache identifier advances without deleting IndexedDB data',async()=>{
  ...
  assert.equal(cache,'cannonmap-v0.7.15-20260822-samsung-camera-backup-p0-1');
  assert.match(source,/stationary-events\.js\?v=20260822-samsung-camera-backup-p0-1/);
  assert.match(index,/stationary-events\.js\?v=20260822-samsung-camera-backup-p0-1/);

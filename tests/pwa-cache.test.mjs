...
test('Mission Control cache identifier advances without deleting IndexedDB data',async()=>{
  ...
  assert.equal(cache,'cannonmap-v0.7.20-20260828-trail-intel-field-hardening-1');
  assert.match(source,/stationary-events\.js\?v=20260828-trail-intel-field-hardening-1/);
  assert.match(index,/stationary-events\.js\?v=20260828-trail-intel-field-hardening-1/);

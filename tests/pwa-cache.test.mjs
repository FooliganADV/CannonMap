...
test('Mission Control cache identifier advances without deleting IndexedDB data',async()=>{
  ...
  assert.equal(cache,'cannonmap-v0.7.16-20260824-samsung-field-rc-1');
  assert.match(source,/stationary-events\.js\?v=20260824-samsung-field-rc-1/);
  assert.match(index,/stationary-events\.js\?v=20260824-samsung-field-rc-1/);

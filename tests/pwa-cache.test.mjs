...
test('Mission Control cache identifier advances without deleting IndexedDB data',async()=>{
  ...
  assert.equal(cache,'cannonmap-v0.7.14-20260821-samsung-rally-state-1');
  assert.match(source,/stationary-events\.js\?v=20260821-samsung-rally-state-1/);
  assert.match(index,/stationary-events\.js\?v=20260821-samsung-rally-state-1/);

...
test('Mission Control cache identifier advances without deleting IndexedDB data',async()=>{
  ...
  assert.equal(cache,'cannonmap-v0.7.21-20260830-target-intel-final-samsung-rc-1');
  assert.match(source,/stationary-events\.js\?v=20260830-target-intel-final-samsung-rc-1/);
  assert.match(index,/stationary-events\.js\?v=20260830-target-intel-final-samsung-rc-1/);

...
test('service worker caches the current UTF-8 backup-interface assets',async()=>{
  ...
  assert.match(sw,/20260822-samsung-camera-backup-p0-1/);
  assert.match(sw,/app\.css\?v=20260822-samsung-camera-backup-p0-1/);
  assert.match(sw,/app\.js\?v=20260822-samsung-camera-backup-p0-1/);
});

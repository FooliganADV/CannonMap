...
test('service worker caches the current UTF-8 backup-interface assets',async()=>{
  ...
  assert.match(sw,/20260816-trail-intel-tactical-1/);
  assert.match(sw,/app\.css\?v=20260816-trail-intel-tactical-1/);
  assert.match(sw,/app\.js\?v=20260816-trail-intel-tactical-1/);
});

const CACHE = 'cannonmap-v0.7.15-20260822-samsung-camera-backup-p0-1';
const RADAR_CACHE='cannonmap-radar-v1',RADAR_CACHE_LIMIT=96;
const APP_SHELL = [
  './',
  './index.html',
  './app.css?v=20260822-samsung-camera-backup-p0-1',
  './gps-checkpoints-feed.js?v=20260725-02',
  './stationary-events.js?v=20260822-samsung-camera-backup-p0-1',
  './app.js?v=20260822-samsung-camera-backup-p0-1',
  './src/core/clock.js',
  ...
  './src/application/checkpoint-evidence-reconciliation-service.js',
  ...
  './src/application/rally-day-preflight-service.js',
  './src/application/screen-wake-lock-controller.js',
  './src/application/automatic-backup-service.js',
  './src/application/backup-scheduler-health.js',
  './src/application/camera-capture-arbiter.js',
  './src/application/coalescing-write-scheduler.js',
  './src/application/gps-watchdog.js',
  './src/application/live-poll-controller.js',
  './src/application/ride-memory-capture-service.js',
  ...
  './src/application/journey-archive-context.js',
  ...
  './src/infrastructure/indexeddb/automatic-backup-repository.js',
  ...
  './src/infrastructure/browser/file-system-backup-adapter.js',
  './src/infrastructure/browser/ride-memory-state-store.js',

...
const stores=[
  ...
  {name:'mediaRecords',keyPath:'mediaId',indexes:[
    ['projectId','projectId'],['checkpointId','checkpointId'],['pairId','pairId'],
    ['createdAt','createdAt'],['projectCreatedAt',['projectId','createdAt']]
  ]},
